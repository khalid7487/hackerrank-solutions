...
function luckBalance(k, contests) {
    ...
    // here we need to sort array with the descending orders
    // if the target value is 0  then just increase the luck 
    // else if key value is greater then 0
    // else decrease luck value
